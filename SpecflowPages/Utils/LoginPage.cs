  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[contains(@name, 'email')]")).SendKeys("ashwini.gantla@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[contains(@name, 'password')]")).SendKeys("test123");
            Thread.Sleep(1000);
